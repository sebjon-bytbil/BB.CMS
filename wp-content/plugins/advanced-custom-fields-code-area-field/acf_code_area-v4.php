...
class acf_field_code_area extends acf_field
{
    ...
    */
    ...
    function input_admin_enqueue_scripts()
    {
        ...
        wp_register_script('acf-input-code_area-code_mirror_mode_js', $this->settings['dir'] . 'js/mode/javascript/javascript.js', array('acf-input'), $this->settings['version']);
        wp_register_script('acf-input-code_area-code_mirror_mode_css', $this->settings['dir'] . 'js/mode/css/css.js', array('acf-input'), $this->settings['version']);
        ...
        wp_register_script('acf-input-code_area-code_mirror_mode_html', $this->settings['dir'] . 'js/mode/htmlmixed/htmlmixed.js', array('acf-input'), $this->settings['version']);
        wp_register_script('acf-input-code_area-code_mirror_mode_xml', $this->settings['dir'] . 'js/mode/xml/xml.js', array('acf-input'), $this->settings['version']);
        wp_register_script('acf-input-code_area-code_mirror_mode_php', $this->settings['dir'] . 'js/mode/php/php.js', array('acf-input'), $this->settings['version']);
        wp_register_script('acf-input-code_area-code_mirror_mode_clike', $this->settings['dir'] . 'js/mode/clike/clike.js', array('acf-input'), $this->settings['version']);
