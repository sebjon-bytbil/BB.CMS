...
if(function_exists("register_field_group"))
{
    ...
    register_field_group(array (
        ...
        'fields' => array (
            array (
                'key' => 'field_56cafb65738c2',
                'label' => 'Textfärg',
                'name' => 'sitesetting-footer-textcolor',
                'type' => 'color_picker',
                'instructions' => 'Välj vilken färg som du vill ha på texten i sidfoten.',
                'default_value' => '#000000',
            ),
            array (
                'key' => 'field_56cafbea738c3',
                'label' => 'Länkfärg',
                'name' => 'sitesetting-footer-linkcolor',
                'type' => 'color_picker',
                'instructions' => 'Välj vilken färg som du vill ha på länkarna i sidfoten.',
                'default_value' => '#000000',
            ),
            array (
                'key' => 'field_56cafc2a738c4',
                'label' => 'Bakgrundsfärg',
                'name' => 'sitesetting-footer-bgcolor',
                'type' => 'color_picker',
                'instructions' => 'Välj vilken färg som du vill ha på sidfoten.',
                'default_value' => '#f1f1f1',
            ),
            array (
                'key' => 'field_56cafc51738c5',
                'label' => 'Genomskinlighet',
                'name' => 'sitesetting-footer-opacity',
                'type' => 'number',
                'instructions' => 'Genomskinligheten på sidfotens bakgrundsfärg.',
                'default_value' => 0,
                'placeholder' => '',
                'prepend' => '',
                'append' => '%',
            ...
            array (
                'key' => 'field_56cafcdc738c7',
                'label' => 'Innehåll',
                'name' => 'sitesetting-footer-content',
                'type' => 'text',
                'instructions' => 'Välj den mall som skall visas i sidfoten.',
                'default_value' => '',
                'placeholder' => '',
                'prepend' => '',
                'append' => '',
